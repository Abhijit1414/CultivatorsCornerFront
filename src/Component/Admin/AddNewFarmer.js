                ...
                <div className="row justify-content-sm-center h-100">
                    <div className="col-xxl-6 col-xl-5 col-lg-5 col-md-7 col-sm-9">
                        <div className="text-center my-4">
                            <img src="https://img.freepik.com/premium-vector/agriculture-farming-with-tractor-with-cultivator-logo-design_1277164-1781.jpg?w=360" alt="logo" width="100" style={{ borderRadius: '50px' }} />
                        </div>
                        ...
                        <div className="text-center mt-4 text-muted">
                            Copyright &copy; 2025 &mdash; 9. Cultivator's Corner
