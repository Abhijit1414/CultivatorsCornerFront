...
function LoginForm() {
	...
	return (
		<div style={{ backgroundColor: '#F4E1C1', minHeight: '100vh' }}> {/* Add light background here */}
			<Toaster
				position="top-center"
				reverseOrder={false}
				toastOptions={{
				...
				<div className="row justify-content-sm-center h-100">
					<div className="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
						<div className="text-center my-5">
							<img src="https://img.freepik.com/premium-vector/agriculture-farming-with-tractor-with-cultivator-logo-design_1277164-1781.jpg?w=360" alt="logo" width="120" style={{ borderRadius: '50px' }} />
						</div>
						<div className="card shadow-lg" style={{ backgroundColor: '#fff' }}> {/* Add background color to the card */}
						...
						<div className="text-center mt-5 text-muted">
							Copyright &copy; 2025 &mdash; Cultivator's Corner
						</div>
					</div>
				</div>
			</div>
